                ...
                while (liner.hasNextLine()) {
                    while (liner.hasNextTokenInLine()) {
                       ...
                       word = word.toLowerCase();
                        ...
                        IntList currentList = words.get(word);
                        currentList.changeParity();
                        if (currentList.getParity()) {
                            currentList.addEntry(wordCount);
                        } else {
                            currentList.increaseAmount();
                        }
                    }
                    for (String key : words.keySet()) {
                        words.get(key).trueParity();
                    }
                    liner.nextLine();
                }
            } finally {
